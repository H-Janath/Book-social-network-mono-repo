...
import { approveReturnBorrowBorrowBook } from '../fn/book/approve-return-borrow-borrow-book';
import { ApproveReturnBorrowBorrowBook$Params } from '../fn/book/approve-return-borrow-borrow-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `approveReturnBorrowBorrowBook()` */
  static readonly ApproveReturnBorrowBorrowBookPath = '/books/borrow/return/approved/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approveReturnBorrowBorrowBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnBorrowBorrowBook$Response(params: ApproveReturnBorrowBorrowBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approveReturnBorrowBorrowBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approveReturnBorrowBorrowBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnBorrowBorrowBook(params: ApproveReturnBorrowBorrowBook$Params, context?: HttpContext): Observable<number> {
    return this.approveReturnBorrowBorrowBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
  ...
  static readonly FindAllBorrowedBooksPath = '/books/borrower';
